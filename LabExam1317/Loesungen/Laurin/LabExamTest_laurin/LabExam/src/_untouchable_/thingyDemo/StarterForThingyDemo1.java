...
/**
 * Die Klasse {@link StarterForThingyDemo1} soll beispielhaft den Umgang mit den "Dingen" aus
...
public class StarterForThingyDemo1 {
    ...
    public static void main( final String... unused ){
        ...
        System.out.printf( "Die Thingies werden durch die %s-Klassebeschrieben.\n",  Item.class.getSimpleName() );
        ...
        System.out.printf(
          ...
          + "o) in ihrem grundsätzlichen Aufbau identisch, aber\n"
