...
package _untouchable_.cardDemo;


// Mit den folgenden 4 import-Statements kommt man "immer" an alles Nötige.
import static _untouchable_.cards.Card.*;
import static _untouchable_.cards.Card.Constant.*;
import _untouchable_.cards.*;
import _untouchable_.cards.Card.*;
...
public class StarterForCardDemo {
    ...
    final static private long encodedVersion = 2___00001_009___2023_06_05__01L; // for LEs23s based on 2___00001_008___2023_04_25__01L
    //-----------------------------------------#---^^^^^-^^^---^^^^-^^-^^--^^
