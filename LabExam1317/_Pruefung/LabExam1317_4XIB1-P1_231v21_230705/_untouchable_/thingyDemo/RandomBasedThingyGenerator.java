...
import _untouchable_.supportGeneral.random.RandomBasedOnPRBS64;
import _untouchable_.supportGeneral.random.RandomBasedOnUtilRandom;
...
public class RandomBasedThingyGenerator implements Serializable {
    ...
    public RandomBasedThingyGenerator( final int maxValue ){
        ...
        final long justSomeSeed = 0xAA55_EE33__5AA5_77CCL;
        randomGenerator = new RandomBasedOnUtilRandom( justSomeSeed );
